...
import { getFirebaseAuth, googleProvider, RecaptchaVerifier } from '@/lib/firebase/client';
...
export default function LoginPage() {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      const confirmation = await signInWithPhoneNumber(getFirebaseAuth(), phone, recaptchaVerifierRef.current);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F0F4F1] via-pharma-gray to-white p-6">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-pharma-text-secondary mt-2">Comment souhaitez-vous acceder a l&apos;application ?</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-pharma-text-secondary mt-1">Saisie rapide des patients</p>
              </div>
            </motion.button>
            ...
            >
              <div className="w-14 h-14 rounded-xl bg-pharma-blue/10 flex items-center justify-center">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1B4F72" strokeWidth="2">
              ...
              <div className="text-center">
                <p className="text-lg font-bold text-pharma-text">Administrateur</p>
                <p className="text-xs text-pharma-text-secondary mt-1">Dashboard et pilotage IA</p>
              </div>
            </motion.button>
          </div>
        </motion.div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-12">
          ...
          >
            ...
            <p className="text-sm text-white/50 max-w-sm mx-auto leading-relaxed">
              Gerez vos patients, suivez les relances et optimisez votre pharmacie avec l&apos;intelligence artificielle.
            </p>
            ...
            >
              {['Suivi patients', 'Relances auto', 'Chat IA', 'Analyses'].map((feature, i) => (
                <motion.span
                  key={feature}
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-gradient-to-br from-white via-pharma-gray to-white relative z-10">
        ...
        >
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-pharma-text">Pharmacie FATIMA</h1>
            <p className="text-sm text-pharma-text-secondary mt-1">CRM Intelligent</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            {mode === 'choice' ? (
              <div className="space-y-4">
                ...
                >
                  {loading ? (
                    <svg className="w-5 h-5 animate-spin text-pharma-text-secondary" viewBox="0 0 24 24" fill="none">
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white px-4 text-pharma-text-secondary font-medium">ou</span>
                  </div>
                </div>
                ...
                {!confirmationResult ? (
                  <>
                    <div className="w-full">
                      <label htmlFor="phone-input" className="block text-sm font-medium text-pharma-text mb-1.5">
                        Numero de telephone
                      </label>
                      <input
                        id="phone-input"
                  ...
                  <>
                    ...
                    <div className="w-full">
                      <label htmlFor="otp-input" className="block text-sm font-medium text-pharma-text mb-1.5">
