                ...
                {assistants.length === 0 ? (
                  <div className="text-center py-6">
                    ...
                    <p className="text-xs text-pharma-text-secondary mt-1">
                      Les assistants apparaitront ici
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {assistants.map((a) => (
                      <div
                        key={a.id}
                        className="flex items-center justify-between p-4 rounded-xl bg-pharma-gray hover:bg-pharma-gray-light transition-colors duration-200 group"
                      >
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-3">
                          <span
                            className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold ${a.status === 'active' ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-600'}`}
                          >
                          ...
                          <button
                            onClick={() =>
                              handleToggleAssistant(a.id, a.status)
                            }
              ...
              <div className="p-6">
                <div className="space-y-1">
                  <div className="flex justify-between items-center py-3 px-4 rounded-xl hover:bg-pharma-gray transition-colors duration-200">
                    ...
                    <span className="text-sm font-medium text-pharma-text">
                      {profile.email || '-'}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-3 px-4 rounded-xl hover:bg-pharma-gray transition-colors duration-200">
