    ...
    <div className="bg-white rounded-2xl shadow-card border border-gray-100 overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-semibold text-pharma-text">Pharmacies enregistrees</h3>
            <p className="text-xs text-pharma-text-secondary mt-0.5">{pharmacies.length} pharmacie{pharmacies.length !== 1 ? 's' : ''} active{pharmacies.length !== 1 ? 's' : ''}</p>
          </div>
        </div>
      </div>
        ...
        {pharmacies.length === 0 ? (
          <div className="text-center py-8">
            <div className="w-16 h-16 rounded-2xl bg-pharma-gray flex items-center justify-center mx-auto mb-4">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#6C757D" strokeWidth="2" strokeLinecap="round">
                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
              </svg>
            </div>
            <p className="text-sm font-medium text-pharma-text">Aucune pharmacie enregistree</p>
            <p className="text-xs text-pharma-text-secondary mt-1">Les pharmacies apparaitront ici</p>
          </div>
        ) : (
          <motion.div
                ...
                <div className="pt-6 pb-4 px-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="text-center p-2 rounded-lg bg-pharma-gray">
                      ...
                      <p className="text-lg font-bold text-pharma-green">{pharmacy.total_patients}</p>
                      <p className="text-[10px] text-pharma-text-secondary font-medium">Patients</p>
                    </div>
                    <div className="text-center p-2 rounded-lg bg-pharma-gray">
                      <div className="flex justify-center mb-1">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#40916C" strokeWidth="2">
                          <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" />
                        </svg>
                      </div>
                      <p className="text-lg font-bold text-pharma-green-medium">{pharmacy.total_admins}</p>
                      <p className="text-[10px] text-pharma-text-secondary font-medium">Admins</p>
                    </div>
                    <div className="text-center p-2 rounded-lg bg-pharma-gray">
                      <div className="flex justify-center mb-1">
                      ...
                      <p className="text-lg font-bold text-pharma-green-light">{pharmacy.total_assistants}</p>
                      <p className="text-[10px] text-pharma-text-secondary font-medium">Assistants</p>
                    </div>
                  </div>
                </div>
              </motion.div>
